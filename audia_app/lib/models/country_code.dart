...
const countries = [
  ...
  CountryCode('\u{1F1F5}\u{1F1F0}', '+92', 'Pakistán', 'PK'),
  ...
  CountryCode('\u{1F1F2}\u{1F1FD}', '+52', 'México', 'MX'),
  CountryCode('\u{1F1EF}\u{1F1F5}', '+81', 'Japón', 'JP'),
  ...
  CountryCode('\u{1F1F9}\u{1F1F7}', '+90', 'Turquía', 'TR'),
  CountryCode('\u{1F1EE}\u{1F1F7}', '+98', 'Irán', 'IR'),
